    ...
    context "when API call is valid", :vcr do
      it "should return tags" do
        expected_tags = [{ "name"        => "v0.0.3",
                           "zipball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/zipball/v0.0.3",
                           "tarball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/tarball/v0.0.3",
                           "commit"      =>
                             { "sha" => "a0cba2b1a1ea9011ab07ee1ac140ba5a5eb8bd90",
                               "url" =>
                                 "https://api.github.com/repos/github-changelog-generator/changelog_test/commits/a0cba2b1a1ea9011ab07ee1ac140ba5a5eb8bd90" } },
                         { "name"        => "v0.0.2",
                           "zipball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/zipball/v0.0.2",
                           "tarball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/tarball/v0.0.2",
                           "commit"      =>
                             { "sha" => "9b35bb13dcd15b68e7bcbf10cde5eb937a54f710",
                               "url" =>
                                 "https://api.github.com/repos/github-changelog-generator/changelog_test/commits/9b35bb13dcd15b68e7bcbf10cde5eb937a54f710" } },
                         { "name"        => "v0.0.1",
                           "zipball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/zipball/v0.0.1",
                           "tarball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/tarball/v0.0.1",
                           "commit"      =>
                             { "sha" => "4c2d6d1ed58bdb24b870dcb5d9f2ceed0283d69d",
                               "url" =>
                                 "https://api.github.com/repos/github-changelog-generator/changelog_test/commits/4c2d6d1ed58bdb24b870dcb5d9f2ceed0283d69d" } },
                         { "name"        => "0.0.4",
                           "zipball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/zipball/0.0.4",
                           "tarball_url" =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/tarball/0.0.4",
                           "commit"      =>
                             { "sha" => "ece0c3ab7142b21064b885061c55ede00ef6ce94",
                               "url" =>
                                 "https://api.github.com/repos/github-changelog-generator/changelog_test/commits/ece0c3ab7142b21064b885061c55ede00ef6ce94" } }]
  ...
  describe "#fetch_closed_issues_and_pr" do
    context "when API call is valid", :vcr do
      ...
      it "returns issue with proper key/values" do
        ...
        expected_issue = { "url"            => "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/14",
                           "repository_url" => "https://api.github.com/repos/github-changelog-generator/changelog_test",
                           "labels_url"     =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/14/labels{/name}",
                           "comments_url"   =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/14/comments",
                           "events_url"     =>
                             "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/14/events",
                           "html_url"       => "https://github.com/github-changelog-generator/changelog_test/issues/14",
                           "id"             => 95_419_412,
                           "number"         => 14,
                           ...
                           "user"           =>
                             { "login"               => "github-changelog-generator",
                               ...
                               "gravatar_id"         => "",
                               "url"                 => "https://api.github.com/users/github-changelog-generator",
                               "html_url"            => "https://github.com/github-changelog-generator",
                               "followers_url"       => "https://api.github.com/users/github-changelog-generator/followers",
                               "following_url"       =>
                                 "https://api.github.com/users/github-changelog-generator/following{/other_user}",
                               "gists_url"           => "https://api.github.com/users/github-changelog-generator/gists{/gist_id}",
                               "starred_url"         =>
                                 "https://api.github.com/users/github-changelog-generator/starred{/owner}{/repo}",
                               "subscriptions_url"   => "https://api.github.com/users/github-changelog-generator/subscriptions",
                               "organizations_url"   => "https://api.github.com/users/github-changelog-generator/orgs",
                               "repos_url"           => "https://api.github.com/users/github-changelog-generator/repos",
                               "events_url"          => "https://api.github.com/users/github-changelog-generator/events{/privacy}",
                               "received_events_url" =>
                                 "https://api.github.com/users/github-changelog-generator/received_events",
                               "type"                => "User",
                               "site_admin"          => false },
                           "labels"         => [],
                           "state"          => "closed",
      ...
      it "returns pull request with proper key/values" do
        ...
        expected_pr = { "url"            => "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/21",
                        "repository_url" => "https://api.github.com/repos/github-changelog-generator/changelog_test",
                        "labels_url"     =>
                          "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/21/labels{/name}",
                        "comments_url"   =>
                          "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/21/comments",
                        "events_url"     =>
                          "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/21/events",
                        "html_url"       => "https://github.com/github-changelog-generator/changelog_test/pull/21",
                        "id"             => 124_925_759,
                        "number"         => 21,
                        ...
                        "pull_request"   =>
                          { "url"       => "https://api.github.com/repos/github-changelog-generator/changelog_test/pulls/21",
                            "html_url"  => "https://github.com/github-changelog-generator/changelog_test/pull/21",
                            "diff_url"  => "https://github.com/github-changelog-generator/changelog_test/pull/21.diff",
                            "patch_url" => "https://github.com/github-changelog-generator/changelog_test/pull/21.patch" },
                        "body"           =>
                          "to test https://github.com/github-changelog-generator/github-changelog-generator/pull/305\r\nshould appear in change log with #20" }
  ...
  describe "#fetch_events_async" do
    context "when API call is valid", :vcr do
      it "populates issues" do
        issues = [{ "url"            => "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/14",
                    "repository_url" => "https://api.github.com/repos/github-changelog-generator/changelog_test",
                    "labels_url"     =>
                      "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/14/labels{/name}",
                    "comments_url"   =>
                    ...
                    "user"           =>
                      { "login"               => "github-changelog-generator",
                        ...
                        "starred_url"         =>
                          "https://api.github.com/users/github-changelog-generator/starred{/owner}{/repo}",
                        "subscriptions_url"   =>
                          "https://api.github.com/users/github-changelog-generator/subscriptions",
                        "organizations_url"   => "https://api.github.com/users/github-changelog-generator/orgs",
                        "repos_url"           => "https://api.github.com/users/github-changelog-generator/repos",
                        "events_url"          => "https://api.github.com/users/github-changelog-generator/events{/privacy}",
                        "received_events_url" =>
        ...
        expected_events = [{ "id"         => 357_462_189,
                             "url"        =>
                               "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/events/357462189",
                             "actor"      =>
                               { "login"               => "github-changelog-generator",
                                 "id"                  => 3_356_474,
                                 "avatar_url"          => "https://avatars.githubusercontent.com/u/3356474?v=3",
                           ...
                           { "id"         => 357_462_542,
                             "url"        =>
                               "https://api.github.com/repos/github-changelog-generator/changelog_test/issues/events/357462542",
                             "actor"      =>
                               { "login"               => "github-changelog-generator",
                                 "id"                  => 3_356_474,
                                 "avatar_url"          => "https://avatars.githubusercontent.com/u/3356474?v=3",
    ...
    context "when API call is valid", :vcr do
      it "returns commit" do
        ...
        expectations = [
          ...
          ["url",
           "https://api.github.com/repos/github-changelog-generator/changelog_test/commits/decfe840d1a1b86e0c28700de5362d3365a29555"],
          # OLD API: "https://api.github.com/repos/github-changelog-generator/changelog_test/git/commits/decfe840d1a1b86e0c28700de5362d3365a29555"],
          ["html_url",
           "https://github.com/github-changelog-generator/changelog_test/commit/decfe840d1a1b86e0c28700de5362d3365a29555"],
          ["author",
           { "login" => "github-changelog-generator", "id" => 3_356_474, "avatar_url" => "https://avatars2.githubusercontent.com/u/3356474?v=4", "gravatar_id" => "", "url" => "https://api.github.com/users/github-changelog-generator", "html_url" => "https://github.com/github-changelog-generator", "followers_url" => "https://api.github.com/users/github-changelog-generator/followers", "following_url" => "https://api.github.com/users/github-changelog-generator/following{/other_user}", "gists_url" => "https://api.github.com/users/github-changelog-generator/gists{/gist_id}", "starred_url" => "https://api.github.com/users/github-changelog-generator/starred{/owner}{/repo}", "subscriptions_url" => "https://api.github.com/users/github-changelog-generator/subscriptions", "organizations_url" => "https://api.github.com/users/github-changelog-generator/orgs", "repos_url" => "https://api.github.com/users/github-changelog-generator/repos", "events_url" => "https://api.github.com/users/github-changelog-generator/events{/privacy}", "received_events_url" => "https://api.github.com/users/github-changelog-generator/received_events", "type" => "User", "site_admin" => false }],
          ["committer",
           { "login" => "github-changelog-generator", "id" => 3_356_474, "avatar_url" => "https://avatars2.githubusercontent.com/u/3356474?v=4", "gravatar_id" => "", "url" => "https://api.github.com/users/github-changelog-generator", "html_url" => "https://github.com/github-changelog-generator", "followers_url" => "https://api.github.com/users/github-changelog-generator/followers", "following_url" => "https://api.github.com/users/github-changelog-generator/following{/other_user}", "gists_url" => "https://api.github.com/users/github-changelog-generator/gists{/gist_id}", "starred_url" => "https://api.github.com/users/github-changelog-generator/starred{/owner}{/repo}", "subscriptions_url" => "https://api.github.com/users/github-changelog-generator/subscriptions", "organizations_url" => "https://api.github.com/users/github-changelog-generator/orgs", "repos_url" => "https://api.github.com/users/github-changelog-generator/repos", "events_url" => "https://api.github.com/users/github-changelog-generator/events{/privacy}", "received_events_url" => "https://api.github.com/users/github-changelog-generator/received_events", "type" => "User", "site_admin" => false }],
          ["parents",
           [{ "sha" => "7ec095e5e3caceacedabf44d0b9b10da17c92e51",
              ...
              # OLD API: "https://api.github.com/repos/github-changelog-generator/changelog_test/git/commits/7ec095e5e3caceacedabf44d0b9b10da17c92e51",
              "html_url" =>
